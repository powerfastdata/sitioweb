...
class DCE_Widget_FileBrowser extends DCE_Widget_Prototype {
	...
	public function displayFileSearch( $settings ) {
		...
		<?php if ( $settings['search_text'] != '' ) {
			echo '<' . $settings['search_text_size'] . ' class="dce-file-search-form-title">' . __($settings['search_text'], 'dynamic-content-for-elementor') . '</' . $settings['search_text_size'] . '>';} ?>
			<div class="form-control"><input type="text" class="filetxt" name="filetxt" value=""></div>
			<?php if ( $settings['search_notice'] ) {
				?><div class="dce-search-desc"><small><?php _e($settings['search_notice'], 'dynamic-content-for-elementor'); ?></small></div><?php } ?>
