	...
	protected function _register_controls() {
		...
		$this->add_control(
				'dce_clipboard_textarea', [
					...
					'label_block' => true,
					'default' => 'I am a sample text.' . PHP_EOL . 'Discover more at Dynamic.ooo',
					'condition' => [
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string('wrapper'); ?>>
			...
			if ( $settings['dce_clipboard_type'] == 'textarea' || $settings['dce_clipboard_type'] == 'code' ) {
				...
				?>
				<?php $this->render_text(); ?>
				<textarea <?php echo $this->get_render_attribute_string('input'); ?>><?php echo $settings['dce_clipboard_type'] == 'textarea' ? $settings['dce_clipboard_textarea'] : $settings['dce_clipboard_code']; ?></textarea>
			<?php } ?>
		</div>
