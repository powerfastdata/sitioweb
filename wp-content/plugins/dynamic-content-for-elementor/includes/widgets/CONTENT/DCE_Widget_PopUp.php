	...
	protected function _register_controls() {
		...
		$this->add_control(
				...
				[
					...
					'description' => __( 'Use a Elementor Template as content of popup, usefull for complex structure.', 'dynamic-content-for-elementor' ),
					'condition' => [
							...
							<div class="modal-body">
								...
								<button type="button" class="dce-close dce-modal-close close-<?php echo $settings['close_type']; ?> close-<?php echo $settings['close_align']; ?> close-<?php echo $settings['close_valign']; ?>" data-dismiss="modal" aria-label="Close">
									...
									<?php if ( $settings['close_type'] == 'text' ) {
										?><span class="dce-button-text"><?php echo __($settings['close_text'], 'dynamic-content-for-elementor' . '_texts'); ?></span><?php } ?>
