...
class DCE_Widget_Svg_PathText extends DCE_Widget_Prototype {
	...
	public function get_name() {
		return 'dyncontel-svgpathText';
	}

	public function get_title() {
		return __('SVG pathText', 'dynamic-content-for-elementor');
	}
	public function get_icon() {
		return 'icon-dyn-svgtextpath';
	}
	...
	public function get_description() {
		return __('The TextPath widget writes a text along a source based on a svg path line', 'dynamic-content-for-elementor');
	}
	public function get_docs() {
		return 'https://www.dynamic.ooo/widget/svg-text-path/';
	}
	...
	protected function render() {
	   ...
	   <svg id="dce-svg-<?php echo $widgetId; ?>" class="dce-svg-pathtext" version="1.1" xmlns="http://www.w3.org/2000/svg"  width="100%" height="100%"  viewBox="0 0 <?php echo $viewBoxW; ?> <?php echo $viewBoxH; ?>" preserveAspectRatio="xMidYMid meet" xml:space="preserve">
			...
			<text id="pathtext-text" fill="<?php echo $text_color; ?>"<?php echo $length_adjust_spacing; ?>><textPath xlink:href="#pathtext-path-<?php echo $widgetId; ?>" startOffset="<?php echo $startOffset; ?>" method="stretch" spacing="auto"><tspan><?php echo __($pathtext_text, 'dynamic-content-for-elementor' . '_texts'); ?></tspan></textPath></text>
		</svg>
		<?php
		echo '</div>';
	}
