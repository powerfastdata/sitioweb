...
class DCE_Widget_Slider extends DCE_Widget_Prototype {
	...
	public function get_description() {
		return __('Use a list of elements generated by an ACF Gallery field and create images carousel', 'dynamic-content-for-elementor');
	}
	...
	public function get_plugin_depends() {
		return [ 'advanced-custom-fields-pro' => 'acf' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
				...
				[
					...
					'type' => Controls_Manager::SLIDER,
					'description' => __('If value is empty the height is automatic.'),
					'default' => [
						'size' => '',
					],
		...
		$this->add_control(
			...
			[
				...
				'description' => __('If so, you will use the system of visualization of the progression of the slides (“bullets”, “fraction”, “progress”)', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_on' => __('Yes', 'dynamic-content-for-elementor'),
				'label_off' => __('No', 'dynamic-content-for-elementor'),
