...
class DCE_Widget_DynamicPosts_Base extends DCE_Widget_Prototype {
    ...
    protected function register_base_controls() {
        ...
        $repeater->start_controls_tab('tab_content', [
            ...
            $repeater->add_responsive_control(
                'ratio_image', [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} {{CURRENT_ITEM}} .dce-img' => 'padding-bottom: calc( {{SIZE}} * 100% );','{{WRAPPER}}:after' => 'content: "{{SIZE}}";',
                    ],
                    'conditions' => [
                        'terms' => [
            ...
            'conditions' => [
                'terms' => [
                    ...
                    [
                        'name' => '_id',
                        'operator' => '!in',
                        'value' => ['item_custommeta','item_author','item_readmore','item_custommeta'],
                    ]
                ]
            ]
        ]);
        ...
        $this->add_control(
                'list_items',
                [
                    'label' => __('<b>VISIBILITY, ORDERING & STYLING</b>', 'dynamic-content-for-elementor'),
                    // 'separator' => 'before',
