	...
	protected function _register_controls() {
		...
		if ( $searchfilterpro_activated ) {
			...
			$this->add_control(
			  ...
			  [
				  'label' => __('<b>Important Note</b>', 'dynamic-content-for-elementor'),
		...
		$this->add_control(
			...
			[
				...
				'default' => '-1',
				'condition' => [
					'query_type' => [ 'get_cpt', 'dynamic_mode', 'relationship', 'search_page' ],
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'term_field_meta',
			[
				'label' => __('Post Term <b>custom meta field</b>', 'dynamic-content-for-elementor'),
				'type' => 'ooo_query',
				'placeholder' => __('Meta key or Name', 'dynamic-content-for-elementor'),
				'label_block' => true,
				'query_type' => 'metas',
		...
		$this->add_control(
			...
			[
				'label' => __('Post Term <b>string field</b>', 'dynamic-content-for-elementor'),
		...
		foreach ( $taxonomies as $tax_key => $a_tax ) {
			if ( $tax_key ) {
				$this->add_control(
					...
					[
						'label' => __('<b>Include</b> Terms of ' . $a_tax, 'dynamic-content-for-elementor'),
						'type' => 'ooo_query',
		...
		$this->add_control(
			...
			[
				'label' => __('<b>Include</b> Operator', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'AND' => [
		...
		foreach ( $taxonomies as $tax_key => $a_tax ) {
			if ( $tax_key ) {
				$this->add_control(
					...
					[
						'label' => __('<b>Exclude</b> Term for ' . $a_tax, 'dynamic-content-for-elementor'),
						'type' => 'ooo_query',
						'placeholder' => __('All terms', 'dynamic-content-for-elementor'),
						'label_block' => true,
						'query_type' => 'terms',
		...
		$this->add_control(
			'author_field_meta',
			[
				'label' => __('Post author <b>custom meta field</b>', 'dynamic-content-for-elementor'),
				'type' => 'ooo_query',
				'placeholder' => __('Meta key or Name', 'dynamic-content-for-elementor'),
				'label_block' => true,
				'query_type' => 'metas',
		...
		$this->add_control(
			...
			[
				'label' => __('Post Author <b>string field</b>', 'dynamic-content-for-elementor'),
		...
		$this->add_control(
			'metakey_field_meta',
			[
				'label' => __('Post Metakey <b>custom meta field</b>', 'dynamic-content-for-elementor'),
				'type' => 'ooo_query',
				'placeholder' => __('Meta key or Name', 'dynamic-content-for-elementor'),
				'label_block' => true,
				'query_type' => 'metas',
				'object_type' => 'post',
				'description' => __('Selected Post Meta value. The meta must return an element of type array or comma separated string that contains IDs of type metakey. (e.g.:array [5,27,88] or 5,27,88)', 'dynamic-content-for-elementor'),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Post Metakey <b>string field</b>', 'dynamic-content-for-elementor'),
		...
		$this->add_control(
			'include_metakey',
			[
				'label' => __('<b>Include</b> Metakey', 'dynamic-content-for-elementor'),
				'type' => 'ooo_query',
		...
		$this->add_control(
			'exclude_metakey',
			[
				'label' => __('<b>Exclude</b> Metakey', 'dynamic-content-for-elementor'),
				'type' => 'ooo_query',
				'placeholder' => __('All metakeys', 'dynamic-content-for-elementor'),
				'label_block' => true,
				'query_type' => 'metakeys',
