	...
	protected function render() {
		...
		if ( $settings['filters_enable'] && $settings['posts_style'] == 'grid' ) {
			...
			if ( ! empty($list_isotope_filters) ) {
				...
				echo '<' . $tag_filter . ' class="users-filters-item filter-active">' . $divider . '<a href="#" data-filter="*">' . __('All', 'dynamic-content-for-elementor') . '</a></' . $tag_filter . '>';
				foreach ( $list_isotope_filters as $filter ) {
					...
					$divider = '<span class="filters-divider">' . $settings['separator_filter'] . '</span>';
					if ( $filternome != '' ) {
