	...
	protected function register_controls_content() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SWITCHER,
				'description' => __('If it is the result from an API call probably is formatted in JSON.', 'dynamic-content-for-elementor'),
				'condition' => [
					'incorporate!' => '',
					'url!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Add a specific format to data elements. Use token to represent JSON fields.', 'dynamic-content-for-elementor'),
				'condition' => [
					'incorporate!' => '',
					'url!' => '',
					'data_json' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::NUMBER,
				'default' => 86400,
				'description' => __('How long cache is valid? Set it in seconds. (86400 is a day, so every day it will be refreshed)', 'dynamic-content-for-elementor'),
				'frontend_available' => true,
				'condition' => [
					'data_cache!' => '',
					'url!' => '',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SWITCHER,
				'description' => __('Enable if remote page contains relative link.', 'dynamic-content-for-elementor'),
			]
		);
		$this->add_control(
			'blank_links',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SWITCHER,
				'description' => __('Enable if you want show lazy images without useing specific javascript.', 'dynamic-content-for-elementor'),
			]
		);
