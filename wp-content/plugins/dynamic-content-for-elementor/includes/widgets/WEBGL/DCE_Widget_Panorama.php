...
class DCE_Widget_Panorama extends DCE_Widget_Prototype {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} a-scene, {{WRAPPER}} .a-scene-placeholder' => 'height: {{SIZE}}{{UNIT}};',
					],
	...
	protected function render() {
		...
		if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
			?>
			<div class="a-scene-placeholder" style="background-image: url('<?php echo $url_image; ?>');background-size: cover;background-position: center center;">
			...
			*/ ?>
			<a-scene <?php echo $fullScreen . $keyboard . $vrmodeui; ?>>
				<a-assets>
					<img id="sky_<?php echo $this->get_id(); ?>" loading="eager" src="<?php echo $url_image; ?>" crossorigin="anonymous">
				</a-assets>
				<?php echo $reversemousecontrol; ?>
				<a-sky src="#sky_<?php echo $this->get_id(); ?>" rotation="0 -130 0"></a-sky>
			</a-scene>
			<?php
			/**/
		}
