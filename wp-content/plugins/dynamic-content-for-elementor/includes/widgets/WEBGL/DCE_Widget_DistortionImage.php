...
class DCE_Widget_DistortionImage extends DCE_Widget_Prototype {

	public function get_name() {
		return 'dyncontel-imagesDistortion';
	}
	public static function is_enabled() {
		return true;
	}
	public function get_title() {
		return __('Images Distortion Hover', 'dynamic-content-for-elementor');
	}
	public function get_icon() {
		return 'icon-dyn-distortion';
	}
	public function get_script_depends() {
		return [ 'dce-threejs-lib', 'dce-tweenMax-lib', 'dce-data-gui', 'dce-displacement-sketch', 'dce-distortion-lib', 'dce-imagesdistortion-js' ];
	}
	public function get_style_depends() {
		return [ 'dce-imagesDistortion' ];
	}
	public function get_docs() {
		return 'https://www.dynamic.ooo/widget/webgl-threejs-images-distortions-hover/';
	}

	public function get_description() {
		return __('Special roollover effects based on webgl, threejs and transformation shaders');
	}
	protected function _register_controls() {
		...
		$this->add_control(
		  'distortion_effect', [
			  'label' => __('Distortion effect', 'dynamic-content-for-elementor'),
			  ...
			  'options' => [
				  'drip' => [
					  'title' => __('Drip', 'dynamic-content-for-elementor'),
					  'return_val' => 'val',
					  'image' => DCE_URL . 'assets/img/distortions/drip.jpg',
				  ],
				  'wave' => [
					  'title' => __('Wave', 'dynamic-content-for-elementor'),
					  'return_val' => 'val',
					  'image' => DCE_URL . 'assets/img/distortions/wave.jpg',
				  ],
				  'ring' => [
					  'title' => __('Ring', 'dynamic-content-for-elementor'),
					  'return_val' => 'val',
					  'image' => DCE_URL . 'assets/img/distortions/ring.jpg',
				  ],
				  'horizdisp' => [
					  'title' => __('Horizontal displacement', 'dynamic-content-for-elementor'),
					  'return_val' => 'val',
					  'image' => DCE_URL . 'assets/img/distortions/horizdisp.jpg',
				  ],
				  'vertdisp' => [
					  'title' => __('Vertical displacement', 'dynamic-content-for-elementor'),
					  'return_val' => 'val',
					  'image' => DCE_URL . 'assets/img/distortions/vertdisp.jpg',
				  ],
				  'displacement' => [
					  'title' => __('Displacement', 'dynamic-content-for-elementor'),
					  'return_val' => 'val',
					  'image' => DCE_URL . 'assets/img/distortions/displacement.jpg',
				  ],
				  'subdivision' => [
					  'title' => __('subdivision', 'dynamic-content-for-elementor'),
					  'return_val' => 'val',
					  'image' => DCE_URL . 'assets/img/distortions/subdivision.jpg',
				  ],
				  'blow' => [
					  'title' => __('Blow', 'dynamic-content-for-elementor'),
					  'return_val' => 'val',
					  'image' => DCE_URL . 'assets/img/distortions/blow.jpg',
				  ],
			  ],
			  'default' => 'drip',
		  ]
		...
		$this->add_control(
		  'width_distortion', [
			  ...
			  'condition' => [
				  'distortion_effect' => 'drip',
			  ],
		  ]
		);
		$this->add_control(
		  'scalex_distortion', [
			  'label' => __('ScaleX', 'dynamic-content-for-elementor'),
			  'type' => Controls_Manager::SLIDER,
			  'default' => [
				  'size' => 40,
			  ],
		...
		$this->add_control(
		  'scaley_distortion', [
			  'label' => __('ScaleY', 'dynamic-content-for-elementor'),
			  'type' => Controls_Manager::SLIDER,
			  'default' => [
				  'size' => 40,
			  ],
		...
		$this->add_control(
		  'width_distortion_ring', [
			  ...
			  'condition' => [
				  'distortion_effect' => 'ring',
			  ],
		  ]
		);

		$this->add_control(
		  'radius_distortion_ring', [
		...
		$this->add_control(
		  'intensity_distortion_vertdisp', [
			  'label' => __('Intensity', 'dynamic-content-for-elementor'),
			  'type' => Controls_Manager::SLIDER,
			  'default' => [
				  'size' => 0.3,
			  ],
			  ...
			  'condition' => [
				  'distortion_effect' => [ 'vertdisp', 'displacement' ],
			  ],
		  ]
		);
		$this->add_control(
		  'intensity_distortion_subdivisionblow', [
			  'label' => __('Intensity', 'dynamic-content-for-elementor'),
			  'type' => Controls_Manager::SLIDER,
			  'default' => [
				  'size' => 50,
			  ...
			  'condition' => [
				  'distortion_effect' => [ 'subdivision', 'blow' ],
			  ],
		  ]
		);
		...
		$this->add_control(
		  'image_displacement', [
			  'label' => __('Displacement Image', 'dynamic-content-for-elementor'),
			  'type' => 'images_selector',
			  'toggle' => false,
			  'type_selector' => 'image',
		...
		$this->add_control(
		  ...
		  [
			  ...
			  'condition' => [
				  'image_displacement' => 'disp_custom',
			  ],
		  ]
		);
		...
		$this->add_responsive_control(
			'align_image', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce_distortion' => 'justify-content: {{VALUE}};',
				],
		...
		$this->add_responsive_control(
			'size_height_image', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce_distortion-content' => 'height: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_responsive_control(
			'size_width_image', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce_distortion-content' => 'width: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_group_control(
			Group_Control_Border::get_type(), [
				...
				'selector' => '{{WRAPPER}} .dce_distortion-content',
			]
		);
		$this->add_control(
			'image_border_radius', [
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .dce_distortion-content' => 'overflow: hidden; border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			'image_padding', [
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .dce_distortion' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
	...
	protected function render() {
		...
		$progress_distortion = ''; //$settings['progress_distortion']['size'];
		...
		$intensity_distortion_subdivisionblow = 50; // 'subdivision','blow'
		...
		$intensity_distortion_vertdisp = 0.3; //vertdisp','displacement
