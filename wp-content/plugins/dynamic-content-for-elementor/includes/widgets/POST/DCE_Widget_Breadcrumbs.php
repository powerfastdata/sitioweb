...
class DCE_Widget_Breadcrumbs extends DCE_Widget_Prototype {
	...
	protected function render() {
		...
		if ( isset($settings['separator'] ) ) {
			$separator = '<span class="dce-separator">' . $settings['separator'] . '</span>';
		}
		$id         = 'dce-breadcrumbs';
		...
		if ( function_exists('yoast_breadcrumb') && $this->is_yoast_breadcrumbs() ) {
			...
			if ( ! is_front_page() ) {
				...
				if ( is_single() ) {
					...
					echo '<li class="item-current item-' . $id_page . '"><span class="bread-current bread-' . $id_page . '" title="' . get_the_title() . '">' . get_the_title() . '</span></li>';
					...
					if ( $post->post_parent ) {
						...
						// Current page
						echo '<li class="item-current item-' . $id_page . '"><span title="' . get_the_title() . '"> ' . get_the_title() . '</span></li>';

					} else {

						// Just display current page if not parents
						echo '<li class="item-current item-' . $id_page . '"><span class="bread-current bread-' . $id_page . '"> ' . get_the_title() . '</span></li>';
