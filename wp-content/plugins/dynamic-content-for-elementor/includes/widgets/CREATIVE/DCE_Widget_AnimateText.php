...
class DCE_Widget_AnimateText extends DCE_Widget_Prototype {
	...
	public function get_script_depends() {
		return [ 'dce-tweenMax-lib', 'dce-timelineMax-lib', 'dce-attr-lib', 'dce-splitText-lib', 'dce-animatetext' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text_word' => __('Write any word', 'dynamic-content-for-elementor'),
					],
				],
				'separator' => 'after',
				'frontend_available' => true,
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'frontend_available' => true,
				'description' => __('Infinite: -1 or do not repeat: 0', 'dynamic-content-for-elementor'),
				'default' => -1,
				'min'     => -1,
				'max'     => 25,
				'step'    => 1,
		...
		$this->add_control(
			'amount_speed_in',
			[
				'label' => __('Amount (negative values produce a contrary effect of origin)', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
