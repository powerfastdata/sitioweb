...
if ( ! Helper::is_elementorpro_active() ) {
	class DCE_Extension_Form_Visibility extends DCE_Extension_Prototype {
		...
		public $name = 'Conditional Fields for Elementor Pro Form';
		...
		public static function _add_to_form( Controls_Stack $element, $control_id, $control_data, $options = [] ) {
			...
			if ( $element->get_name() == 'form' && $control_id == 'form_fields' ) {
				...
				$control_data['fields']['dce_field_visibility_multiple'] = array(
					...
					'label' => __('Single/Multiple Fields', 'dynamic-content-for-elementor'),
					'options' => [
						'single' => __('Single', 'dynamic-content-for-elementor'),
						'yes' => __('Multiple', 'dynamic-content-for-elementor'),
					],
					'condition' => array(
				...
				$control_data['fields']['dce_field_visibility_value_multiple'] = array(
					...
					'tabs_wrapper' => 'form_fields_tabs',
					'inner_tab' => 'form_fields_visibility_tab',
					'description' => __('One value per line, if multiple fields type them in the same order of the selected fields', 'dynamic-content-for-elementor'),
					'condition' => array(
						'dce_field_visibility_mode!' => 'visible',
						'dce_field_visibility_multiple' => 'yes',
					),
				...
				$control_data['fields']['dce_field_visibility_multiple_logic'] = array(
					...
					'options' => [
						'&&' => __('AND', 'dynamic-content-for-elementor'),
						'||' => __('OR', 'dynamic-content-for-elementor'),
					],
					'condition' => array(
						'dce_field_visibility_mode!' => 'visible',
						'dce_field_visibility_multiple' => 'yes',
