...
function _dce_extension_form_telegram( $field ) {
	switch ( $field ) {
		case 'docs':
			return 'https://www.dynamic.ooo/widget/telegram-for-elementor-pro-form/';
		case 'description':
			return __('Send to Telegram the content of your Elementor Pro Form.', 'dynamic-content-for-elementor');
	}
}
...
if ( ! Helper::is_elementorpro_active() || ! class_exists('ElementorPro\Modules\Forms\Classes\Action_Base') ) {
	...
	class DCE_Extension_Form_Telegram extends DCE_Extension_Prototype {
		...
		public $name = 'Telegram for Elementor Pro Form';
