		...
		return [
			...
			'controls' => [
				'enable_smoothtransition' => [
					'label' => __('Enable Smooth Transition', 'dynamic-content-for-elementor'),
				...
				'selector_wrapper' => [
					...
					'default' => '',
					'label_block' => true,
					'placeholder' => __('Write CSS selector (e.g.:#wrapper)', 'dynamic-content-for-elementor'),
					'frontend_available' => true,
					'dynamic' => [
						'active' => false,
					],
              ...
              -webkit-animation-fill-mode: both;
				...
				'dce_smoothtransition_settings_note' => [
					'type' => Controls_Manager::RAW_HTML,
					'raw' => __('The selector wrapper is very important for the proper functioning of the transitions. It indicates the part of the page that needs to be transformed. <a href="https://docs.dynamic.ooo/article/149-html-structure-of-themes" target="_blank">This article can help you.</a>', 'dynamic-content-for-elementor'),
					'content_classes' => '',
					'condition' => [
						'enable_smoothtransition' => 'yes',
					],
				...
				'smoothtransition_overlay_image' => [
					...
					'selectors' => [
						$wrapper . '.smoothtransition-overlay:after',
						$wrapper . '.smoothtransition-overlay.overlay-out:after' => 'background-image: url({{URL}});',
					],
				],
				...
				'smoothtransition_debug_loading' => [
					'label' => __('Enable loading on editor mode', 'dynamic-content-for-elementor'),
					'type' => Controls_Manager::SWITCHER,
				...
				'smoothtransition_loading_style' => [
					...
					'default' => 'fade',
					'options' => [
						'rotate' => __('Rotate', 'dynamic-content-for-elementor'),
						'pulse' => __('Pulse', 'dynamic-content-for-elementor'),
				...
				'responsive_smoothtransition' => [
					'label' => __('Apply Smooth Transition on:', 'dynamic-content-for-elementor'),
