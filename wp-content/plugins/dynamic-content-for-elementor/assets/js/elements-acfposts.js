    ...
    var WidgetElementsPostsDCEHandler = function ($scope, $) {
        ...
        if ($objBlock_acfposts.data('style') == 'grid') {
            ...
            var swiperOptions = {
                ...
                navigation: {
                    nextEl: id_post ? '.dce-elementor-post-' + id_post + ' .elementor-element-' + id_scope + ' .next-' + id_scope : '.next-' + id_scope, //'.swiper-button-next',
                    prevEl: id_post ? '.dce-elementor-post-' + id_post + ' .elementor-element-' + id_scope + ' .prev-' + id_scope : '.prev-' + id_scope, //'.swiper-button-prev',
                    //hideOnClick: false,
                ...
                // watchSlidesVisibility:  Boolean( elementSettings.watchSlidesVisibility ), // false, // WatchSlidesProgress should be enabled. Enable this option and slides that are in viewport will have additional visible classes
                /*scrollbar: {
