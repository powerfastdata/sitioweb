(function ($) {
    ...
    var WidgetElements_DualViewHandler = function ($scope, $) {
        ...
        var dualViewistance = $scope.find('.dce-dualView');
        ...
        class Grid {
            constructor(el) {
                ...
                // The content items.
                this.contents = [];
                Array.from(document.querySelectorAll('.dualview-content > .content__item')).forEach(contentEl => this.contents.push(new Content(contentEl)));
            ...
            initEvents() {
                ...
                this.keyesc = (event) => {
                    ...
                    if (chCode == 27 && this.current != -1 && !this.isAnimating) {
                        this.closeItem();
                    }

                };
                document.addEventListener('keyup', this.keyesc, false);
            }
        ...
        const grid = new Grid(document.querySelector('.dualview-grid-' + dualViewId));
