...
if(texts.length>1){switch(eff_out){case 'fading':tl.staggerTo(splitter,speed_out,{opacity:0,delay:delaySteps_out,stagger:staggerOpt_out,ease:anim_easing_out},null,null,changeText);break;case 'to_left':tl.staggerTo(splitter,speed_out,{x:-100,opacity:0,delay:delaySteps_out,stagger:staggerOpt_out,ease:anim_easing_out},null,null,changeText);break;case 'to_right':tl.staggerTo(splitter,speed_out,{x:100,opacity:0,delay:delaySteps_out,stagger:staggerOpt_out,ease:anim_easing_out},null,null,changeText);break;case 'to_top':tl.staggerTo(splitter,speed_out,{y:-100,opacity:0,delay:delaySteps_out,stagger:staggerOpt_out,ease:anim_easing_out},null,null,changeText);break;case 'to_bottom':tl.staggerTo(splitter,speed_out,{y:100,opacity:0,delay:delaySteps_out,stagger:staggerOpt_out,ease:anim_easing_out},null,null,changeText);break;case 'zoom_front':tl.staggerTo(splitter,speed_out,{scale:1.6,opacity:0,delay:delaySteps_out,stagger:staggerOpt_out,ease:anim_easing_out},null,null,changeText);break;case 'zoom_back':tl.staggerTo(splitter,speed_out,{scale:0.1,opacity:0,delay:delaySteps_out,stagger:staggerOpt_out,ease:anim_easing_out},null,null,changeText);break;case 'random_position':tl.staggerTo(splitter,speed_out,{opacity:0,cycle:{scale:function(){return random(0.1,3)},x:function(){return random(-500,500)},y:function(){return random(-500,500)},z:function(){return random(-500,500)},rotation:function(){return random(-120,120)}},delay:delaySteps_out,stagger:staggerOpt_out,ease:anim_easing_out},null,null,changeText);break;case 'elastic':tl.staggerTo(splitter,0.5,{opacity:0,stagger:{ease:Linear.easeNone,axis:null,amount:0.5,from:splitOrigin,},ease:anim_easing_out},0.08,2);break;default:break}}};changeAndSplittingText(count,old_count);if(elementSettings.animatetext_trigger=='animation'){riproduci()}else if(elementSettings.animatetext_trigger=='rollover'){}else if(elementSettings.animatetext_trigger=='scroll'){active_scrollAnalysi(target)}};$(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/dyncontel-animateText.default',WidgetElements_AnimateTextHandler)})})(jQuery)