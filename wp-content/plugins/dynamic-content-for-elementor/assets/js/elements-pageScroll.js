( function( $ ) {
	...
	var WidgetElements_PageScroll = function(  ) {
		...
		set_sectionHeight();
		if(settings_page && settings_page.scrollEffects_navigation) {
			$('body').append('<nav class="scrollEffects-nav"><ul class="cd-vertical-nav"><li><a href="#0" class="cd-prev inactive">Next</a></li><li><a href="#0" class="cd-next">Prev</a></li></ul></nav>');
		}
