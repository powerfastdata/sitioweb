...
let jsconv = JSON.parse(urlParams.get('downloadPDF'));
...
const newURL = window.location.href.replace(/.downloadPDF=.*/g, "");
...
function downloadPDF() {
    ...
    html2canvas(el, { windowWidth: 1024, windowHeight: 768 }).then(canvas => {
        ...
        // The following is necessary for the case where canvas is so long that
