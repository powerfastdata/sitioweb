...
class Notice {
	...
	public static function dce_admin_notice__license() {
		...
		<div class="error notice-error notice dce-generic-notice">
			...
			<?php _e( 'Your copy seems not to be activated, please <a href="' . admin_url() . 'admin.php?page=dce_opt&tab=license">activate it</a> or <a href="https://www.dynamic.ooo/pricing" target="blank">buy a new license</a>.', 'dynamic-content-for-elementor' ); ?></p>
		</div>
	<?php }
	}
