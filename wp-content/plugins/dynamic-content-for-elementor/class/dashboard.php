	...
	public function dyncontel_dashboard_overview_widget() {
		...
		<div class="e-dashboard-widget">
			...
			<div class="dce-overview__footer">
				<ul>
					<!-- <li class="dce-overview__docs"><a href="docs.dynamic.ooo" target="_blank">Docs <span class="screen-reader-text"><?php echo __('(open in a new window)', 'elementor'); ?></span><span aria-hidden="true" class="dashicons dashicons-external"></span></a></li> -->
					<li class="dce-overview__help"><a href="https://www.dynamic.ooo/" target="_blank">Dynamic.ooo <span class="screen-reader-text"><?php echo __('(open in a new window)', 'elementor'); ?></span><span aria-hidden="true" class="dashicons dashicons-external"></span></a></li>
				</ul>
			</div>
		</div>
		<?php
