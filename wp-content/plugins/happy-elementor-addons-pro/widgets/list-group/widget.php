        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .ha-list-item a:hover .ha-icon svg' => 'fill: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .ha-list-item a .ha-direction svg' => 'fill: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .ha-list-item a:hover .ha-direction svg' => 'fill: {{VALUE}}',
                ],
            ]
        );
