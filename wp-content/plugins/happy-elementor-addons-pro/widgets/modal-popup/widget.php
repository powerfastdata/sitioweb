...
class Modal_Popup extends Base {
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Modal Content', 'happy-addons-pro' ),
			...
			<div class="ha-modal-animation animate__animated">
				<div class="ha-modal-inner">
					<div class="ha-modal-inner-content">
						<?php if ( !empty( $settings['modal_image']['url'] || $settings['modal_image']['id'] ) ) :
	...
	protected function render() {
		...
		<div class="ha-modal-button-wrapper">
			<a <?php $this->print_render_attribute_string( 'modal-button' ); ?>>
				<?php echo esc_html( $settings['button'] ); ?>
			</a>
		</div>

		<?php
		$this->modal_popup_content( $widget_id );
	}
