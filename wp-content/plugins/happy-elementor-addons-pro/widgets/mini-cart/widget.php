...
class Mini_Cart extends Base {
	 ...
	 * Content controls
	 */
	protected function content_tab_controls( ) {
        ...
        $this->add_responsive_control(
            ...
            [
				...
				'prefix_class' => 'ha-mini-cart-align-',
                'default' => 'left',
            ]
        );
	...
	protected function register_style_controls() {
		...
		$this->cart_btn_style_controls();

		//Body Style Start
		$this->body_style_controls();
		...
		//Subtotal Style Start
		$this->subtotal_style_controls();

		//Button Style Start
		$this->btn_style_controls();

	}


	/**
	 * Mini Cart Style controls
	 */
	protected function cart_btn_style_controls() {
	 ...
	 * Body Style controls
	 */
	protected function body_style_controls(){
	 ...
	 */
	protected function header_style_controls(){
	...
	/**
	 * Subtotal Style controls
	 */
	protected function subtotal_style_controls(){
	 ...
	 */
	protected function btn_style_controls(){
