...
use Happy_Addons_Pro\Blog_Post_Handler;
...
class Smart_Post_List extends Base {
	...
	protected function register_content_controls () {
		...
		//Top Bar Settings
		$this->top_bar_content_controls();

		//Featured Post Settings
		$this->featured_post_content_controls();

		//List Post Settings
		$this->list_post_content_controls();
	 ...
	 */
	protected function layout_content_controls (){
	 ...
	 */
	protected function top_bar_content_controls (){
	...
	/**
	 * Featured Post Content controls
	 */
	protected function featured_post_content_controls (){
	...
	/**
	 * List Post Content controls
	 */
	protected function list_post_content_controls (){
	...
	protected function register_style_controls () {
		...
		//Top Bar Style
		$this->top_bar_style_controls();

		//Top Bar Title Style
		$this->top_bar_title_style_controls();

		//Top Bar Filter Style
		$this->top_bar_filter_style_controls();

		//Top Bar Navigation Style
		$this->top_bar_navigation_style_controls();

		//Featured Post Style
		$this->featured_post_style_controls();

		//Featured Post Badge Style
		$this->featured_post_badge_style_controls();

		//List Post Style
		$this->list_post_style_controls();
	}

	/**
	 * Layout Style controls
	 */
	protected function layout_style_controls(){
	...
	/**
	 * Top Bar Style controls
	 */
	protected function top_bar_style_controls() {
	...
	/**
	 * Top Bar Title Style controls
	 */
	protected function top_bar_title_style_controls(){
	...
	/**
	 * Top Bar Filter Style controls
	 */
	protected function top_bar_filter_style_controls(){
	...
	/**
	 * Top Bar Navigation Style controls
	 */
	protected function top_bar_navigation_style_controls(){
	...
	/**
	 * Featured Post Style controls
	 */
	protected function featured_post_style_controls(){
	...
	/**
	 * Featured Post Badge Style controls
	 */
	protected function featured_post_badge_style_controls(){
	...
	/**
	 * List Post Style controls
	 */
	protected function list_post_style_controls(){
